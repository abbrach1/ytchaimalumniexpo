...
import { CarouselImage, Announcement, YTCEvent, Shiur } from '../../types';
          ...
          {announcements.length > 0 && (
            <View style={styles.section}>
              ...
              {announcements.map((ann) => (
                <View key={ann.id} style={[styles.card, ann.isMazelTov && styles.mazelTovCard]}>
                  {ann.isMazelTov && (
                    <View style={styles.mazelTovBadge}>
                      <Text style={styles.mazelTovBadgeText}>🎉 Mazel Tov</Text>
                    </View>
                  )}
                ...
                <View style={styles.shiurInfo}>
                  ...
                  {recentShiur.tags.length > 0 && (
                    <View style={styles.tags}>
                      {recentShiur.tags.slice(0, 3).map((tag) => (
...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: Colors.creamOpacity70, fontSize: 12 },
