...
import { fetchRebbeim, fetchApprovedAlumni } from '../../services/firebase';
import { Rebbe, AlumniContact } from '../../types';
            ...
            <View style={styles.rebbeCard}>
              {rebbe.photoUrl ? (
                ...
                <View style={styles.rebbePhotoPlaceholder}>
                  <Text style={styles.rebbeInitial}>{rebbe.name[0]}</Text>
                </View>
              )}
          ...
          <View style={styles.searchRow}>
            <View style={styles.searchBox}>
              ...
              <TextInput
                ...
                value={alumniSearch}
                onChangeText={setAlumniSearch}
              />
              {alumniSearch ? (
                <TouchableOpacity onPress={() => setAlumniSearch('')}>
            ...
            renderItem={({ item: contact }) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => setExpandedId(isExpanded ? null : contact.id)}>
                  <View style={styles.alumniRow}>
                    <View style={styles.alumniAvatar}>
                      <Text style={styles.alumniAvatarText}>{contact.name[0]}</Text>
                    </View>
                    <View style={styles.alumniInfo}>
                      <Text style={styles.alumniName}>{contact.name}</Text>
                      {contact.location && (
                        <Text style={styles.alumniLocation}>📍 {contact.location}</Text>
                      )}
                    </View>
                    <Ionicons
